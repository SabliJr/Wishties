...
import { onAddSocialLinks } from '../controllers/socialLinksController';
...
router.post('/update-profile', upload.array('profile_images'), onProfileUpdate) // edit or update profile
router.post('/add-social-links', onAddSocialLinks) // add social links at the creation of the profile
