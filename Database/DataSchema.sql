...
creator_id UUID REFERENCES creator(creator_id) ON
DELETE CASCADE, -- wishlist_id UUID REFERENCES wishlist(wishlist_id),
...
supported_creator_id UUID REFERENCES creator(creator_id) ON
DELETE CASCADE,
...
fan_id UUID REFERENCES fan(fan_id) ON
DELETE CASCADE,
       wish_id UUID REFERENCES wish(wish_id) ON
DELETE CASCADE,
       purchased_for UUID REFERENCES creator(creator_id) ON
DELETE CASCADE, -- Changed data type
...
received_creator_id UUID REFERENCES creator(creator_id) ON
DELETE CASCADE,
       received_from UUID REFERENCES fan(fan_id) ON
DELETE
SET NULL,
    received_number_of_wishes INT DEFAULT 0,
received_wish_id UUID REFERENCES wish(wish_id) ON
DELETE
SET NULL,
