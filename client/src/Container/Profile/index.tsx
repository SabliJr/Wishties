...
const Index = () => {
  ...
  let creator_bio = creatorInfo?.creator_bio
    ...
    : !creatorInfo.creator_bio && user_info?.creator_id && user_info.username
    ? "No bio yet, say something to your fans!"
    : null;

  const HandleFilteringCategories = () => {
    setDisplayCategories((prevDisplayCategories) => !prevDisplayCategories);
    setDisplayFilters(false);
  };

  const handleDisplayFilters = () => {
    setDisplayFilters((prevDisplayFilters) => !prevDisplayFilters);
