...
const CreatorPage = () => {
  ...
  const handleSentSurprise = async () => {
    ...
    if (Number(surpriseGift.amount) < 1) {
    ...
    // localStorage.setItem(
    //   "surprise_gift_amount",
    //   JSON.stringify(surpriseGift.amount)
    // );
    // localStorage.setItem(
    //   "surprise_gift_suggested_use",
    //   JSON.stringify(surpriseGift.suggestedUse)
    // );
    // localStorage.setItem(
    //   "surprise_gift_image",
    //   JSON.stringify(SurpriseGiftImag)
    // );
    // navigate("/cart");
  };
  console.log(surpriseErr);
